...
[GlobalParams]
  ...
  coupled_rad    = 'r1 r2 r3  r4   r5 r6 r7'
  # coupled_atoms  = '1  2  3   4.5  6.75'
  # coupled_widths = '1  1  1.5 2.25 1'
  coupled_atoms  = '1 2 3 4 5 6 7'
  coupled_widths = '1 1 1 1 1 1 1'
  allow_loss = false
[]
...
[Postprocessors]
  ...
  [./total_sum]
    ...
    postprocessors = 'c1 c2 c3 c4 c5 c6 c7'
    # coupled_widths = '1  1  1.5 2.25 1'
    # factors = '1 2 3 4.5 6.75'
    # factors = '1 2 4.5 10.125 6.75'
    factors = '1 2 3 4 5 6 7'
  [../]
  [./total_conc]
    type = SumOfPostprocessors
    postprocessors = 'c2 c3 c4 c5 c6 c7'
  [../]
[]
